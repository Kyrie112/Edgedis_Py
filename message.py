...
class Message_Data_Sender:  # how to use this class to help sender to send out data
    def __init__(self, id, data, padlen, data_id, from_host, from_port):
...
class Message_Data_Sender_Response:
    def __init__(self, id, data_id, status, file_status, from_host, from_port):
        self.type = 'data_sender_response'
        self.id = id
        self.data_id = data_id
        self.status = status
        self.file_status = file_status  # changed here(whether the receivers need to tell the senders they have already
        # received file.)
        self.from_host = from_host
        self.from_port = from_port
...
class Message_Data_Client:
    def __init__(self, data, padlen, original_data_blocks_cnt, check_data_block_cnt, data_id, from_host, from_port):
        self.type = 'data_client'
        self.data = data
        self.data_id = data_id
        self.original_data_blocks_cnt = original_data_blocks_cnt
